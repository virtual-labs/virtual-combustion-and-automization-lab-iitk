...
<div class="post">
		...
		<h1 class="title"><a href="#">Delete Tab</a></h1>
				
				<div class="entry">

					 <p>

<form action=del_tab.php method="post">			
...
mysql_select_db ("lms");
$stuff = mysql_query("SELECT tid,caption FROM menu WHERE cid='".$course_id."'") or die("MySQL Login Error: ".mysql_error()); 
...
while($row = mysql_fetch_array($stuff))
 ...
 $tid=$row['tid'];
 $cap=$row['caption'];
echo "<option value=$tid>$cap</option>";
  }

}
?>
</select>
<input name="tabcap" type="hidden" value=<?php echo $cap ?> size="50" /><br><br>				
<br>
