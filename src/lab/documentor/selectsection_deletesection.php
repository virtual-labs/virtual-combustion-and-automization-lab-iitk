...
<div class="post">
		...
		<h1 class="title"><a href="#">Select section to Delete</a></h1>
				
				<div class="entry">

					 <p>

<form action=del_section.php method="post">			
						
  
<select name="post">              				<label><b> Select Tab :</b></label><br>
...
mysql_select_db ("lms");
$stuff = mysql_query("SELECT pid,title FROM content WHERE tid='".$tabid."'") or die("MySQL Login Error: ".mysql_error()); 
