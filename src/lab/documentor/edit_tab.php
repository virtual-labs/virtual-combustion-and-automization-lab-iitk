...
mysql_select_db ("lms");
$stuff = mysql_query("SELECT caption FROM menu WHERE cid='".$course_id."' AND tid ='".$tabid."'") or die("MySQL Login Error: ".mysql_error()); 
...
<form action=func.edittab.php method="post">
			...
			<input name="tabid" type="hidden" value=<?php echo $tabid ?> size="50" /><br><br>
<br>
