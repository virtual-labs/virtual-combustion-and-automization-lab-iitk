...
RUN mkdir /virtual-combustion-and-automization-lab-iitk

COPY src/ /virtual-combustion-and-automization-lab-iitk/src

WORKDIR ./virtual-combustion-and-automization-lab-iitk/src
